...
namespace AlpaStock.Core.Migrations
{
    ...
    [Migration("20250309102659_stock wishlist")]
    partial class stockwishlist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlpaStock.Core.Entities.CommunityChannelMessage", b =>
                {
                    ...
                    b.Property<string>("ChannelCategoryId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AlpaStock.Core.Entities.CommunityChannelMessage", b =>
                {
                    b.HasOne("AlpaStock.Core.Entities.ChannelCategory", "ChannelCategory")
                        .WithMany()
                        .HasForeignKey("ChannelCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlpaStock.Core.Entities.CommunityChannel", null)
